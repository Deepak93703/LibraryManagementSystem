    ...
    if (isset($_POST['profile_submit'])) {
        $res = updateProfile($conn, $_POST, $_FILES);
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <label class="input-group-text" for="profile_pic" id="file_name_label">
                                                    <?php echo $_SESSION['user']['profile_pic'] ?? 'Choose file'; ?>
                                                </label>
                                            </div>

                                            <div class="mt-2">
                                                <?php if ($_SESSION['user']['profile_pic']) { ?>
                                                    <img src="<?php echo BASE_URL . 'assets/uploads/' . $_SESSION['user']['profile_pic'] ?>"
                                                        class="profile-pic"
